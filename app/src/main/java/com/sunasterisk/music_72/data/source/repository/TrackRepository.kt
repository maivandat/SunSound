...
interface TrackRepository{
    ...
    fun getTracksSearchResult(query: String, limit: Int): Observable<MutableList<Track>>
}
...
class TrackRepositoryImplementor(
    ...
    override fun getTracksSearchResult(query: String, limit: Int) =
        remote.getTracksSearchResult(query, limit)
}
